                    ...
                    <form action="controller.do" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="tel" class="form-control" name="populacao" id="fone" maxlength="15"  value="${pais.populacao }">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="email">Area</label>
                                <input type="email" class="form-control" name="area" id="email" required maxlength="60"  value="${pais.area }">
                            </div>
                        </div>
                        <hr />
